from app.repositories.historical_traffic_repository import (
    historical_traffic_repository,
)
...
class HistoricalTrafficService:
    ...
    def get_traffic_by_route(
        ...
        return historical_traffic_repository.get_by_route(
            origin=origin,
